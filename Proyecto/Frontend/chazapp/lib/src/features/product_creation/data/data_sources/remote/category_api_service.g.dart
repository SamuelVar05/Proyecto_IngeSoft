...
class _CategoryApiService implements CategoryApiService {
  ...
  @override
  Future<HttpResponse<ApiResponse<List<CategoryModel>>>> getCategories(
      String token) async {
    ...
    final _options =
        _setStreamType<HttpResponse<ApiResponse<List<CategoryModel>>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late ApiResponse<List<CategoryModel>> _value;
    try {
      _value = ApiResponse<List<CategoryModel>>.fromJson(
        _result.data!,
